...
class be_haxer_hxswfml_HxmWriter {
	...
	public function getZIP($initName) {
		...
		$zip = null;
		if(!$this->useFolders) {
			$start = "import format.abc.Data;\x0A" . "import format.swf.Data;\x0A" . "import neko.Lib;\x0A" . "import sys.FileSystem;\x0A" . "import sys.io.File;\x0A" . "class GenSWF\x0A" . "{\x0A" . "\x09public static function main()\x0A" . "\x09{\x0A" . "\x09\x09new GenSWF();\x0A" . "\x09}\x0A" . "\x09public function new()\x0A" . "\x09{\x0A" . "\x09\x09var inits:Map<String,Index<MethodType>> = new Map();\x0A" . "\x09\x09var classes:Map<String,Index<ClassDef>> = new Map();\x0A" . "\x09\x09var ctx:format.abc.Context = new format.abc.Context();\x0A" . "\x09\x09var localFunctions:Map<String,Index<MethodType>>=new Map();\x0A" . "\x09\x09//------------------\x0A" . "\x09\x09initLocalFunctions(localFunctions, ctx, classes);\x0A" . "\x09\x09//------------------\x0A";
			$middle = "";
			{
			...
			$buildFile = "-main GenSWF\x0A" . "#replace with path to the format lib of hxswfml\x0A" . "-cp ../../../../../src\x0A" . "-D no-pattern-matching\x0A" . "-x gen_swf";
			...
			$start = "import format.abc.Data;\x0A" . "import format.swf.Data;\x0A" . "import neko.Lib;\x0A" . "import sys.FileSystem;\x0A" . "import sys.io.File;\x0A" . "class GenSWF\x0A" . "{\x0A" . "\x09public static function main()\x0A" . "\x09{\x0A" . "\x09\x09new GenSWF();\x0A" . "\x09}\x0A" . "\x09public function new()\x0A" . "\x09{\x0A" . "\x09\x09var inits:Map<String,Index<MethodType>> = new Map();\x0A" . "\x09\x09var classes:Map<String,Index<ClassDef>> = new Map();\x0A" . "\x09\x09var ctx:format.abc.Context = new format.abc.Context();\x0A" . "\x09\x09var localFunctions:Map<String,Index<MethodType>>=new Map();\x0A\x09\x09//------------------\x0A" . "\x09\x09LocalFunctions_abc.write(ctx, inits,classes, localFunctions);\x0A";
			{
				$_g = 0; $_g1 = $this->packages;
				while($_g < $_g1->length) {
					$i = $_g1[$_g];
					...
					$pre = "" . "package " . _hx_string_or_null($p3) . ";\x0A" . "import format.abc.Data;\x0A" . "class " . _hx_string_or_null($cn) . "_abc\x0A" . "{\x0A" . "\x09public static function write(ctx:format.abc.Context, inits:Map<String,Index<MethodType>>,classes:Map<String,Index<ClassDef>>, localFunctions:Map<String,Index<MethodType>>):Void\x0A" . "\x09{\x0A";
					$post = "" . "\x09}\x0A" . "}\x0A";
			...
			$txt = "package;\x0A" . "import format.abc.Data;\x0A" . "class LocalFunctions_abc\x0A" . "{\x0A" . "\x09public static function write(ctx:format.abc.Context, inits:Map<String,Index<MethodType>>,classes:Map<String,Index<ClassDef>>, localFunctions:Map<String,Index<MethodType>>):Void\x0A" . "\x09{\x0A" . "\x09\x09var f = null;\x0A" . _hx_string_or_null($this->localFunctions) . "\x09}\x0A" . "}\x0A";
