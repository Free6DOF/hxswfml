...
function sys_io_FileInput_0(&$__hx__this, &$r) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
function sys_io_FileInput_1(&$__hx__this, &$l, &$p, &$s) {
	throw new HException(new haxe_io_Eof());
}
function sys_io_FileInput_2(&$__hx__this, &$l, &$p, &$r, &$s) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
function sys_io_FileInput_3(&$__hx__this) {
	throw new HException(new haxe_io_Eof());
}
function sys_io_FileInput_4(&$__hx__this, &$r) {
	throw new HException(haxe_io_Error::Custom("An error occurred"));
}
