...
import format.mpeg.audio.Element;
import format.mpeg.audio.Emphasis;
import format.mpeg.audio.Frame;
import format.mpeg.audio.FrameHeader;
import format.mpeg.audio.Info;
import format.mpeg.audio.Layer;
import format.mpeg.audio.Mode;
import format.mpeg.audio.MpegAudio;
import format.mpeg.audio.MpegAudioReader;
import format.mpeg.audio.MpegVersion;
import format.mpeg.audio.Utils;
