...
<Custom/>
        ...
        <Custom tagId="12" data="0x07,0x00" comment="DoAction tag with following code: 0x07, 0x00 means stop(); in AS2"/>

<swf></swf>
        Parent: none (root/document element)
        Children:
                <FileAttributes/>,<SetBackgroundColor/>,<ScriptLimits/>,<MetaData/>
                <DefineBitsJPEG/>,<DefineShape/>,<DefineSprite>,<DefineButton>,<DefineBinaryData/>,<DefineSound/>,<DefineFont/>,<DefineEditText/>,<DefineScalingGrid/>,<DefineABC/>,
