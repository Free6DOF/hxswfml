...
class Xml {
	...
	static function createPCDataFromCustomParser($data) {
		$r = new Xml(true);
	...
	static $__properties__ = array("set_nodeName" => "set_nodeName","get_nodeName" => "get_nodeName","set_nodeValue" => "set_nodeValue","get_nodeValue" => "get_nodeValue","get_parent" => "get_parent");
