...
OpCode  OpCode_obj::OApplyType(int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OApplyType",10),47,DynamicArray(0,1).Add(nargs)); }

OpCode  OpCode_obj::OArray(int nvalues)
	{ return CreateEnum<OpCode_obj >(STRING(L"OArray",6),49,DynamicArray(0,1).Add(nvalues)); }
...
OpCode  OpCode_obj::OAsType(format::abc::Index t)
	{ return CreateEnum<OpCode_obj >(STRING(L"OAsType",7),80,DynamicArray(0,1).Add(t)); }

OpCode OpCode_obj::OBreakPoint;

OpCode  OpCode_obj::OBreakPointLine(int n)
	{ return CreateEnum<OpCode_obj >(STRING(L"OBreakPointLine",15),94,DynamicArray(0,1).Add(n)); }

OpCode  OpCode_obj::OCallMethod(int slot,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallMethod",11),36,DynamicArray(0,2).Add(slot).Add(nargs)); }

OpCode  OpCode_obj::OCallPropLex(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallPropLex",12),44,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OCallPropVoid(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallPropVoid",13),46,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OCallProperty(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallProperty",13),39,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OCallStack(int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallStack",10),34,DynamicArray(0,1).Add(nargs)); }

OpCode  OpCode_obj::OCallStatic(format::abc::Index meth,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallStatic",11),37,DynamicArray(0,2).Add(meth).Add(nargs)); }

OpCode  OpCode_obj::OCallSuper(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallSuper",10),38,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OCallSuperVoid(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCallSuperVoid",14),45,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OCast(format::abc::Index t)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCast",5),77,DynamicArray(0,1).Add(t)); }

OpCode  OpCode_obj::OCatch(int c)
	{ return CreateEnum<OpCode_obj >(STRING(L"OCatch",6),53,DynamicArray(0,1).Add(c)); }

OpCode OpCode_obj::OCheckIsXml;

OpCode  OpCode_obj::OClassDef(format::abc::Index c)
	{ return CreateEnum<OpCode_obj >(STRING(L"OClassDef",9),51,DynamicArray(0,1).Add(c)); }

OpCode  OpCode_obj::OConstruct(int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OConstruct",10),35,DynamicArray(0,1).Add(nargs)); }

OpCode  OpCode_obj::OConstructProperty(format::abc::Index name,int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OConstructProperty",18),43,DynamicArray(0,2).Add(name).Add(nargs)); }

OpCode  OpCode_obj::OConstructSuper(int nargs)
	{ return CreateEnum<OpCode_obj >(STRING(L"OConstructSuper",15),42,DynamicArray(0,1).Add(nargs)); }

OpCode  OpCode_obj::ODebugFile(format::abc::Index file)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODebugFile",10),93,DynamicArray(0,1).Add(file)); }

OpCode  OpCode_obj::ODebugLine(int line)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODebugLine",10),92,DynamicArray(0,1).Add(line)); }

OpCode  OpCode_obj::ODebugReg(format::abc::Index name,int r,int line)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODebugReg",9),91,DynamicArray(0,3).Add(name).Add(r).Add(line)); }

OpCode  OpCode_obj::ODecrIReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODecrIReg",9),88,DynamicArray(0,1).Add(r)); }

OpCode  OpCode_obj::ODecrReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODecrReg",8),83,DynamicArray(0,1).Add(r)); }

OpCode  OpCode_obj::ODeleteProp(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"ODeleteProp",11),65,DynamicArray(0,1).Add(p)); }
...
OpCode  OpCode_obj::OFindDefinition(format::abc::Index d)
	{ return CreateEnum<OpCode_obj >(STRING(L"OFindDefinition",15),56,DynamicArray(0,1).Add(d)); }

OpCode  OpCode_obj::OFindProp(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OFindProp",9),55,DynamicArray(0,1).Add(p)); }

OpCode  OpCode_obj::OFindPropStrict(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OFindPropStrict",15),54,DynamicArray(0,1).Add(p)); }

OpCode  OpCode_obj::OFloat(format::abc::Index v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OFloat",6),29,DynamicArray(0,1).Add(v)); }
...
OpCode  OpCode_obj::OFunction(format::abc::Index f)
	{ return CreateEnum<OpCode_obj >(STRING(L"OFunction",9),33,DynamicArray(0,1).Add(f)); }

OpCode  OpCode_obj::OGetDescendants(format::abc::Index c)
	{ return CreateEnum<OpCode_obj >(STRING(L"OGetDescendants",15),52,DynamicArray(0,1).Add(c)); }

OpCode OpCode_obj::OGetGlobalScope;

OpCode  OpCode_obj::OGetLex(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OGetLex",7),57,DynamicArray(0,1).Add(p)); }

OpCode  OpCode_obj::OGetProp(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OGetProp",8),63,DynamicArray(0,1).Add(p)); }

OpCode  OpCode_obj::OGetScope(int n)
	{ return CreateEnum<OpCode_obj >(STRING(L"OGetScope",9),62,DynamicArray(0,1).Add(n)); }

OpCode  OpCode_obj::OGetSlot(int s)
	{ return CreateEnum<OpCode_obj >(STRING(L"OGetSlot",8),66,DynamicArray(0,1).Add(s)); }
...
OpCode  OpCode_obj::OIncrIReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"OIncrIReg",9),87,DynamicArray(0,1).Add(r)); }

OpCode  OpCode_obj::OIncrReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"OIncrReg",8),82,DynamicArray(0,1).Add(r)); }

OpCode  OpCode_obj::OInitProp(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OInitProp",9),64,DynamicArray(0,1).Add(p)); }

OpCode OpCode_obj::OInstanceOf;

OpCode  OpCode_obj::OInt(int v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OInt",4),19,DynamicArray(0,1).Add(v)); }

OpCode  OpCode_obj::OIntRef(format::abc::Index v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OIntRef",7),27,DynamicArray(0,1).Add(v)); }

OpCode  OpCode_obj::OIsType(format::abc::Index t)
	{ return CreateEnum<OpCode_obj >(STRING(L"OIsType",7),86,DynamicArray(0,1).Add(t)); }

OpCode  OpCode_obj::OJump(format::abc::JumpStyle j,int delta)
	{ return CreateEnum<OpCode_obj >(STRING(L"OJump",5),9,DynamicArray(0,2).Add(j).Add(delta)); }
...
OpCode  OpCode_obj::ONamespace(format::abc::Index v)
	{ return CreateEnum<OpCode_obj >(STRING(L"ONamespace",10),31,DynamicArray(0,1).Add(v)); }

OpCode OpCode_obj::ONewBlock;

OpCode  OpCode_obj::ONext(int r1,int r2)
	{ return CreateEnum<OpCode_obj >(STRING(L"ONext",5),32,DynamicArray(0,2).Add(r1).Add(r2)); }
...
OpCode  OpCode_obj::OObject(int nfields)
	{ return CreateEnum<OpCode_obj >(STRING(L"OObject",7),48,DynamicArray(0,1).Add(nfields)); }

OpCode  OpCode_obj::OOp(format::abc::Operation op)
	{ return CreateEnum<OpCode_obj >(STRING(L"OOp",3),96,DynamicArray(0,1).Add(op)); }
...
OpCode  OpCode_obj::OReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"OReg",4),59,DynamicArray(0,1).Add(r)); }
...
OpCode  OpCode_obj::OSetProp(format::abc::Index p)
	{ return CreateEnum<OpCode_obj >(STRING(L"OSetProp",8),58,DynamicArray(0,1).Add(p)); }

OpCode  OpCode_obj::OSetReg(int r)
	{ return CreateEnum<OpCode_obj >(STRING(L"OSetReg",7),60,DynamicArray(0,1).Add(r)); }

OpCode  OpCode_obj::OSetSlot(int s)
	{ return CreateEnum<OpCode_obj >(STRING(L"OSetSlot",8),67,DynamicArray(0,1).Add(s)); }
...
OpCode  OpCode_obj::OSmallInt(int v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OSmallInt",9),18,DynamicArray(0,1).Add(v)); }

OpCode  OpCode_obj::OString(format::abc::Index v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OString",7),26,DynamicArray(0,1).Add(v)); }

OpCode OpCode_obj::OSwap;

OpCode  OpCode_obj::OSwitch(int def,Array<int > deltas)
	{ return CreateEnum<OpCode_obj >(STRING(L"OSwitch",7),10,DynamicArray(0,2).Add(def).Add(deltas)); }
...
OpCode  OpCode_obj::OUIntRef(format::abc::Index v)
	{ return CreateEnum<OpCode_obj >(STRING(L"OUIntRef",8),28,DynamicArray(0,1).Add(v)); }

OpCode OpCode_obj::OUndefined;

OpCode  OpCode_obj::OUnknown(int byte)
	{ return CreateEnum<OpCode_obj >(STRING(L"OUnknown",8),97,DynamicArray(0,1).Add(byte)); }

DEFINE_CREATE_ENUM(OpCode_obj)

int OpCode_obj::__FindIndex(String inName)
{
	if (inName==STRING(L"OApplyType",10)) return 47;
	if (inName==STRING(L"OArray",6)) return 49;
	if (inName==STRING(L"OAsAny",6)) return 78;
	if (inName==STRING(L"OAsObject",9)) return 81;
	if (inName==STRING(L"OAsString",9)) return 79;
	if (inName==STRING(L"OAsType",7)) return 80;
	if (inName==STRING(L"OBreakPoint",11)) return 0;
	if (inName==STRING(L"OBreakPointLine",15)) return 94;
	if (inName==STRING(L"OCallMethod",11)) return 36;
	if (inName==STRING(L"OCallPropLex",12)) return 44;
	if (inName==STRING(L"OCallPropVoid",13)) return 46;
	if (inName==STRING(L"OCallProperty",13)) return 39;
	if (inName==STRING(L"OCallStack",10)) return 34;
	if (inName==STRING(L"OCallStatic",11)) return 37;
	if (inName==STRING(L"OCallSuper",10)) return 38;
	if (inName==STRING(L"OCallSuperVoid",14)) return 45;
	if (inName==STRING(L"OCast",5)) return 77;
	if (inName==STRING(L"OCatch",6)) return 53;
	if (inName==STRING(L"OCheckIsXml",11)) return 76;
	if (inName==STRING(L"OClassDef",9)) return 51;
	if (inName==STRING(L"OConstruct",10)) return 35;
	if (inName==STRING(L"OConstructProperty",18)) return 43;
	if (inName==STRING(L"OConstructSuper",15)) return 42;
	if (inName==STRING(L"ODebugFile",10)) return 93;
	if (inName==STRING(L"ODebugLine",10)) return 92;
	if (inName==STRING(L"ODebugReg",9)) return 91;
	if (inName==STRING(L"ODecrIReg",9)) return 88;
	if (inName==STRING(L"ODecrReg",8)) return 83;
	if (inName==STRING(L"ODeleteProp",11)) return 65;
	if (inName==STRING(L"ODup",4)) return 24;
	if (inName==STRING(L"ODxNs",5)) return 5;
	if (inName==STRING(L"ODxNsLate",9)) return 6;
	if (inName==STRING(L"OFalse",6)) return 21;
	if (inName==STRING(L"OFindDefinition",15)) return 56;
	if (inName==STRING(L"OFindProp",9)) return 55;
	if (inName==STRING(L"OFindPropStrict",15)) return 54;
	if (inName==STRING(L"OFloat",6)) return 29;
	if (inName==STRING(L"OForEach",8)) return 17;
	if (inName==STRING(L"OForIn",6)) return 13;
	if (inName==STRING(L"OFunction",9)) return 33;
	if (inName==STRING(L"OGetDescendants",15)) return 52;
	if (inName==STRING(L"OGetGlobalScope",15)) return 61;
	if (inName==STRING(L"OGetLex",7)) return 57;
	if (inName==STRING(L"OGetProp",8)) return 63;
	if (inName==STRING(L"OGetScope",9)) return 62;
	if (inName==STRING(L"OGetSlot",8)) return 66;
	if (inName==STRING(L"OGetSuper",9)) return 3;
	if (inName==STRING(L"OHasNext",8)) return 14;
	if (inName==STRING(L"OIncrIReg",9)) return 87;
	if (inName==STRING(L"OIncrReg",8)) return 82;
	if (inName==STRING(L"OInitProp",9)) return 64;
	if (inName==STRING(L"OInstanceOf",11)) return 85;
	if (inName==STRING(L"OInt",4)) return 19;
	if (inName==STRING(L"OIntRef",7)) return 27;
	if (inName==STRING(L"OIsType",7)) return 86;
	if (inName==STRING(L"OJump",5)) return 9;
	if (inName==STRING(L"OLabel",6)) return 8;
	if (inName==STRING(L"ONaN",4)) return 22;
	if (inName==STRING(L"ONamespace",10)) return 31;
	if (inName==STRING(L"ONewBlock",9)) return 50;
	if (inName==STRING(L"ONext",5)) return 32;
	if (inName==STRING(L"ONop",4)) return 1;
	if (inName==STRING(L"ONull",5)) return 15;
	if (inName==STRING(L"OObject",7)) return 48;
	if (inName==STRING(L"OOp",3)) return 96;
	if (inName==STRING(L"OPop",4)) return 23;
	if (inName==STRING(L"OPopScope",9)) return 12;
	if (inName==STRING(L"OPushWith",9)) return 11;
	if (inName==STRING(L"OReg",4)) return 59;
	if (inName==STRING(L"ORegKill",8)) return 7;
	if (inName==STRING(L"ORet",4)) return 41;
	if (inName==STRING(L"ORetVoid",8)) return 40;
	if (inName==STRING(L"OScope",6)) return 30;
	if (inName==STRING(L"OSetProp",8)) return 58;
	if (inName==STRING(L"OSetReg",7)) return 60;
	if (inName==STRING(L"OSetSlot",8)) return 67;
	if (inName==STRING(L"OSetSuper",9)) return 4;
	if (inName==STRING(L"OSetThis",8)) return 90;
	if (inName==STRING(L"OSmallInt",9)) return 18;
	if (inName==STRING(L"OString",7)) return 26;
	if (inName==STRING(L"OSwap",5)) return 25;
	if (inName==STRING(L"OSwitch",7)) return 10;
	if (inName==STRING(L"OThis",5)) return 89;
	if (inName==STRING(L"OThrow",6)) return 2;
	if (inName==STRING(L"OTimestamp",10)) return 95;
	if (inName==STRING(L"OToBool",7)) return 74;
	if (inName==STRING(L"OToInt",6)) return 71;
	if (inName==STRING(L"OToNumber",9)) return 73;
	if (inName==STRING(L"OToObject",9)) return 75;
	if (inName==STRING(L"OToString",9)) return 68;
	if (inName==STRING(L"OToUInt",7)) return 72;
	if (inName==STRING(L"OToXml",6)) return 69;
	if (inName==STRING(L"OToXmlAttr",10)) return 70;
	if (inName==STRING(L"OTrue",5)) return 20;
	if (inName==STRING(L"OTypeof",7)) return 84;
	if (inName==STRING(L"OUIntRef",8)) return 28;
	if (inName==STRING(L"OUndefined",10)) return 16;
	if (inName==STRING(L"OUnknown",8)) return 97;
...
{
Static(OAsAny) = CreateEnum<OpCode_obj >(STRING(L"OAsAny",6),78);
Static(OAsObject) = CreateEnum<OpCode_obj >(STRING(L"OAsObject",9),81);
Static(OAsString) = CreateEnum<OpCode_obj >(STRING(L"OAsString",9),79);
Static(OBreakPoint) = CreateEnum<OpCode_obj >(STRING(L"OBreakPoint",11),0);
Static(OCheckIsXml) = CreateEnum<OpCode_obj >(STRING(L"OCheckIsXml",11),76);
Static(ODup) = CreateEnum<OpCode_obj >(STRING(L"ODup",4),24);
Static(ODxNsLate) = CreateEnum<OpCode_obj >(STRING(L"ODxNsLate",9),6);
Static(OFalse) = CreateEnum<OpCode_obj >(STRING(L"OFalse",6),21);
Static(OForEach) = CreateEnum<OpCode_obj >(STRING(L"OForEach",8),17);
Static(OForIn) = CreateEnum<OpCode_obj >(STRING(L"OForIn",6),13);
Static(OGetGlobalScope) = CreateEnum<OpCode_obj >(STRING(L"OGetGlobalScope",15),61);
Static(OHasNext) = CreateEnum<OpCode_obj >(STRING(L"OHasNext",8),14);
Static(OInstanceOf) = CreateEnum<OpCode_obj >(STRING(L"OInstanceOf",11),85);
Static(OLabel) = CreateEnum<OpCode_obj >(STRING(L"OLabel",6),8);
Static(ONaN) = CreateEnum<OpCode_obj >(STRING(L"ONaN",4),22);
Static(ONewBlock) = CreateEnum<OpCode_obj >(STRING(L"ONewBlock",9),50);
Static(ONop) = CreateEnum<OpCode_obj >(STRING(L"ONop",4),1);
Static(ONull) = CreateEnum<OpCode_obj >(STRING(L"ONull",5),15);
Static(OPop) = CreateEnum<OpCode_obj >(STRING(L"OPop",4),23);
Static(OPopScope) = CreateEnum<OpCode_obj >(STRING(L"OPopScope",9),12);
Static(OPushWith) = CreateEnum<OpCode_obj >(STRING(L"OPushWith",9),11);
Static(ORet) = CreateEnum<OpCode_obj >(STRING(L"ORet",4),41);
Static(ORetVoid) = CreateEnum<OpCode_obj >(STRING(L"ORetVoid",8),40);
Static(OScope) = CreateEnum<OpCode_obj >(STRING(L"OScope",6),30);
Static(OSetThis) = CreateEnum<OpCode_obj >(STRING(L"OSetThis",8),90);
Static(OSwap) = CreateEnum<OpCode_obj >(STRING(L"OSwap",5),25);
Static(OThis) = CreateEnum<OpCode_obj >(STRING(L"OThis",5),89);
Static(OThrow) = CreateEnum<OpCode_obj >(STRING(L"OThrow",6),2);
Static(OTimestamp) = CreateEnum<OpCode_obj >(STRING(L"OTimestamp",10),95);
Static(OToBool) = CreateEnum<OpCode_obj >(STRING(L"OToBool",7),74);
Static(OToInt) = CreateEnum<OpCode_obj >(STRING(L"OToInt",6),71);
Static(OToNumber) = CreateEnum<OpCode_obj >(STRING(L"OToNumber",9),73);
Static(OToObject) = CreateEnum<OpCode_obj >(STRING(L"OToObject",9),75);
Static(OToString) = CreateEnum<OpCode_obj >(STRING(L"OToString",9),68);
Static(OToUInt) = CreateEnum<OpCode_obj >(STRING(L"OToUInt",7),72);
Static(OToXml) = CreateEnum<OpCode_obj >(STRING(L"OToXml",6),69);
Static(OToXmlAttr) = CreateEnum<OpCode_obj >(STRING(L"OToXmlAttr",10),70);
Static(OTrue) = CreateEnum<OpCode_obj >(STRING(L"OTrue",5),20);
Static(OTypeof) = CreateEnum<OpCode_obj >(STRING(L"OTypeof",7),84);
Static(OUndefined) = CreateEnum<OpCode_obj >(STRING(L"OUndefined",10),16);
}
